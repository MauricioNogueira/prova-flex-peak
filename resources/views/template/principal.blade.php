					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="{{ route('tela-cadastrar-aluno') }}">Cadastrar</a></li>
								<li><a href="{{ route('listar-alunos') }}">Listar</a></li>
							</ul>
						</li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="{{ route('tela-cadastrar-curso') }}">Cadastrar</a></li>
								<li><a href="{{ route('listar-cursos') }}">Listar</a></li>
							</ul>
						</li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="{{ route('tela-cadastrar-professor') }}">Cadastrar</a></li>
								<li><a href="{{ route('listar-professores') }}">Listar</a></li>
							</ul>
						</li>
					</ul>
				</div>
